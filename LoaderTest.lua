        ...
        if SeaEvent then
            pcall(function()
                ...
                elseif CheckSeaBeast() then
                    ...
                    chodienspamhirimixienchetcuchungmay = false
                    NoClip = false
                elseif Enemies:FindFirstChild("Shark") or Enemies:FindFirstChild("Piranha") or Enemies:FindFirstChild("Terrorshark") then
                    if LP.Character.Humanoid.Sit then
                        LP.Character.Humanoid.Sit = false
                    end
                    for i,v in pairs(Enemies:GetChildren()) do
                        if (v.Name == "Shark" or v.Name == "Piranha" or v.Name == "Terrorshark") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            repeat task.wait()
                                EBuso()
                                EWeapon(Selecttool)
                                ...
                                NoClip = true
                            until not Enemies:FindFirstChild("Shark") or not Enemies:FindFirstChild("Piranha") or not Enemies:FindFirstChild("Terrorshark") or v.Humanoid.Health <= 0 or not SeaEvent
                            NoClip = false
                        end
                    end
