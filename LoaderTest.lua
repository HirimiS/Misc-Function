--Hirimi Hub Hyper - Rewrite Fixed #7.1
...
MainTab:AddSlider({Name = "Delay Attack", Min = 10, Max = 100, Default = func["CDAAT"], Color = Color3.fromRGB(255, 255, 255), Increment = 1, ValueName = "Speed", Callback = function()
end
})
MainTab:AddSlider({Name = "Time Wait", Min = 7, Max = 20, Default = func["TimeWait"], Color = Color3.fromRGB(255, 255, 255), Increment = 1, ValueName = "Wait", Callback = function()
    end
})
MainTab:AddSlider({Name = "Time Wait", Min = 0.1, Max = 2, Default = func["DelayAttack"], Color = Color3.fromRGB(255, 255, 255), Increment = 1, ValueName = "Wait", Callback = function()
end
})
MainTab:AddToggle({
...
local FastAttackLoadString = loadstring(game:HttpGet("https://raw.githubusercontent.com/Hirimii/Functions-More/main/1-Functions-AttackLoad.lua"))()
spawn(function()
    while wait() do
        if EnableFastAttack then
            if EnableAttack or DamageArua then
                FastAttackLoadString:InputValue(CountDownAttackNext)
                FastAttackLoadString:Attack(true)
            else
                FastAttackLoadString:Attack(false)
            end
        end
    end
end)
...
SettingTab:AddSlider({Name = "Stop Health Mastery", Min = 0, Max = 100, Default = 40, Color = Color3.fromRGB(255,255,255), Increment = 1, ValueName = "%", Callback = function(vHealthm)
    HealthStop = vHealthm
end    
})
